...
function _toTimeStampNumber(timeStamp, // @arg UINT - time stamp.
    ...
    // SCR値は33bit+9bit = 42bit の情報ですが、これらは33bitと9bitに分けて解釈する必要があります
    ...
    // MPEG2 ではMPEG1 との差分 0〜299を9bitで表現し、33bit+9bit = 42bit で 27MHz のクロックを表現しています
    // したがって上位33bit は MPEG1 と同じ 90kHz分のクロック情報が乗っており、下位9bitに0〜299までの値が乗っています
    //   0 = `000000000`
    // 299 = `100101011`
