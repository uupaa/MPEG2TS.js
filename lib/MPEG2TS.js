...
function _getTSPacketType(ts, PID) { // @ret PackgeTypeString: PackgeType
    switch (PID) {
    case 0x0000: return "PAT";      // Program Association Table
    case 0x0001: return "CAT";      // Conditional Access Table
    case 0x0002: return "TSDT";     // Transport Stream Description Table
    case 0x0003: return "IPMPCIT";  // IPMP Control Information Table
    case 0x1FFF: return "NULL";     // Null packet
    default:
        switch (true) {
