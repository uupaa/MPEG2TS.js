...
var MPEG2TSParser = global["WebModule"]["MPEG2TSParser"];
...
// --- class / interfaces ----------------------------------
var MPEG2TS = {
    "parse":                        MPEG2TSParser["parse"],                 // MPEG2TS.parse(source:Uint8Array, cursor:UINT32 = 0, options:Object = {}):MPEG2TSPacketObject
    "convertPacketToPESPacket":     MPEG2TS_convertPacketToPESPacket,       // MPEG2TS.convertPacketToPESPacket(packet:MPEG2TSPacketUint8ArrayArray):MPEG2TSPESPacketObjectArray
...
// --- implements ------------------------------------------
function MPEG2TS_convertPacketToPESPacket(packet) { // @arg MPEG2TSPacketUint8ArrayArray - [PAT, PMT, VIDEO_TS_PACKET, ...]
